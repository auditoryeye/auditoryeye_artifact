...
However, due to the size of dataset, the downloaded zip file might be truncated by Github. For instance, the subfolder E8Angle05 may not exist in the downloaded file. If this happens, users can use tools such as [download-directory](https://download-directory.github.io/), [GitZip](http://kinolien.github.io/gitzip/), [DownGit](https://minhaskamal.github.io/DownGit/#/home), to download the specific directory.  We also provided alternative links in the above table to download the specific directory. 
